...
local module = ShaguTweaks:register({
  title = T["Show Enhanced Micro Menu"],
  description = T["Hold <CTRL> and <SHIFT> to move from the left or right edge. Press the arrow on the right to conceal the bar. Only works when when Shagu's Reduced actionbar module is enabled. Disable <Show Micro Menu> from ShaguTweaks-extra"],
...
module.enable = function(self)
  ...
  ShaguTweaks_config["EnhancedMicroMenu"] =
    ShaguTweaks_config["EnhancedMicroMenu"] or {}
  local movedb = ShaguTweaks_config["EnhancedMicroMenu"]
